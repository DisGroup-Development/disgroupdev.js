// Acknowledgement: discord.js for providing this script on GitHub (https://github.com/discordjs/discord-api-types/blob/main/scripts/actions/create-release.mjs)
...
console.log(`🎉 Creating new release for disgroupdev.js ${packageJson.version}`);
