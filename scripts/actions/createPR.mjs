// Acknowledgement: discord.js for providing this script on GitHub (https://github.com/discordjs/discord-api-types/blob/main/scripts/bump-version.mjs)
...
const pullRequestBody = [
	...
	'',
	`This pull request bumps disgroupdev.js from **${previousRelease?.tag_name ?? 'unknown'}** to **${
		packageJson.version
	}**.`,
	'',
