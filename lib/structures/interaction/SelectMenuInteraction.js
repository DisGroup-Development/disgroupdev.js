 ...
 * @property {Array<PermissionFlagsBits>} clientPermissions The permissions required for the client to execute the select menu interaction (default: [])
 * @property {Array<PermissionFlagsBits>} userPermissions The permissions required for the user to execute the select menu interaction (default: [])
 ...
 * @property {SelectMenuOptionBuilder[]} options The options of the select menu
...
class SelectMenuInteraction extends BaseComponent {
     ...
     * @param {SelectMenuInteractionManager} manager The select menu interaction manager
     * @param {SelectMenuInteractionData} data The data of the select menu interaction
     */
     ...
     * @returns {SelectMenuBuilder|DisGroupDevError}
     * @public
     */
    buildSelectMenu() {
        try {
