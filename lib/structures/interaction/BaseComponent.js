 ...
 * @property {Array<PermissionFlagsBits>} clientPermissions The permissions required for the client to execute the base component (default: [])
 * @property {Array<PermissionFlagsBits>} userPermissions The permissions required for the user to execute the base component (default: [])
...
class BaseComponent {
     ...
     * @param {BaseComponentData} data The data of the base component
     */
     ...
     * @param {String} path The new path of the base component
     * @public
     */
    set location(path) {
