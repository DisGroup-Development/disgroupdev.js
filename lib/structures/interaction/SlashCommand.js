const { ApplicationCommandOptionData, Client, Snowflake, TextBasedChannelTypes } = require('discord.js');
const { LocalizationMap, PermissionFlagsBits } = require('discord-api-types/v10');
