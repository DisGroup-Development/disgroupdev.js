const { Client, MessageActionRow, MessageActionRowComponentResolvable, Modal, TextBasedChannelTypes } = require('discord.js');
    ...
    buildModal() {
        ...
        try {
            ...
            for(const component of this.components) {
                ...
                modalComponents.push(new MessageActionRow().addComponents(compoent));
