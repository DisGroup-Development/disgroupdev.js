...
const { DisGroupDevError } = require('../../errors/DisGroupDevError');
 ...
 * @property {Array<PermissionFlagsBits>} clientPermissions The permissions required for the client to execute the modal interaction (default: [])
 * @property {Array<PermissionFlagsBits>} userPermissions The permissions required for the user to execute the modal interaction (default: [])
 * @property {String} category The category of the modal interaction (Will be set automatically. default: "Other")
 * @property {...TextInputBuilder[]} components The components of the modal
...
class ModalInteraction extends BaseComponent {
     ...
     * @param {ModalInteractionManager} manager The modal interaction manager
     * @param {ModalInteractionData} data The data of the modal interaction
     */
    ...
    /**
     * Builds the modal
     * @returns {ModalBuilder|DisGroupDevError}
     * @public
     */
    buildModal() {
        try {
            ...
            for (const component of this.components) {
                modalComponents.push(new ActionRowBuilder().addComponents(component));
            }
