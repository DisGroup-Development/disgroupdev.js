const { Client, EmojiIdentifierResolvable, MessageButton, MessageButtonStyle, PermissionString, TextBasedChannelTypes } = require('discord.js');
 ...
 * @property {Array<PermissionString>} clientPermissions The permissions required for the client to execute the button interaction (default: [])
 * @property {Array<PermissionString>} userPermissions The permissions required for the user to execute the button interaction (default: [])
 ...
 * @property {EmojiIdentifierResolvable} emoji The emoji of the button
 ...
 * @property {MessageButtonStyle} style The style of the button (default: SUCCESS)
...
class ButtonInteraction extends BaseComponent {
     ...
     * @returns {EmojiIdentifierResolvable|null}
     */
    get emoji() {
    ...
    get style() {
        ...
        return this.data.style ?? 'SUCCESS';
