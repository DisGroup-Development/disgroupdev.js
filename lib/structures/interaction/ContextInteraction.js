const { Client, Snowflake, TextBasedChannelTypes } = require('discord.js');
const { ApplicationCommandType, LocalizationMap } = require('discord-api-types/v10');
 ...
 * @property {Boolean} defaultEnabled If the context interaction is enabled by default (default: false)
...
class ContextInteraction extends BaseInteraction {
    ...
    /**
     * If the context interaction is enabled by default
     * @returns {Boolean}
     * @public
     */
    get defaultEnabled() {
    ...
    /**
     * If deploying is enabled for the context interaction
     * @returns {Boolean}
     * @public
     */
    get deployEnabled() {
