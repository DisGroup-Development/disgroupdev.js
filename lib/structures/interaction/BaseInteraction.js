 ...
 * @property {Array<PermissionString>} clientPermissions The permissions required for the client to execute the base interaction (default: [])
 * @property {Array<PermissionString>} userPermissions The permissions required for the user to execute the base interaction (default: [])
...
class BaseInteraction {
    ...
    /**
     * If the interaction is premium access only
     * @returns {Boolean}
     * @public
     */
    get premiumOnly() {
