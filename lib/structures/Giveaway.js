const { Client, ColorResolvable, EmojiResolvable, Message, MessageMentionOptions, MessageReaction, Snowflake, resolveColor } = require('discord.js');
...
class Giveaway {
    ...
    get messageReaction() {
        ...
        const reactionEmoji = this.client.emojis.resolve(this.reaction);
    ...
    get reaction() {
        ...
        if(!this.data.reaction && this.message) {
            ...
            const emoji = this.client.emojis.resolve('🎉');
