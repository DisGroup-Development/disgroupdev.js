const { Client, Collection, ColorResolvable, EmojiResolvable, Message, MessageMentionOptions, MessageReaction, Snowflake, User, resolveColor, resolvePartialEmoji } = require('discord.js');
...
class Giveaway {
    ...
    /**
     * Pauses the giveaway
     * @param {GiveawayPauseOptions} options
     * @returns {Promise<Giveaway>}
     */
    pause(options) {

        return this.manager.pause(this, options);
    ...
    reroll(options) {
        ...
        return this.manager.reroll(this, options);
    ...
    unpause() {
        ...
        return this.manager.unpause(this);
