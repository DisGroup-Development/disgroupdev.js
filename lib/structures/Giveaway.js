const { Client, ColorResolvable, EmojiResolvable, Message, MessageMentionOptions, Snowflake, resolveColor } = require('discord.js');
...
class Giveaway {
    ...
    get reaction() {
        ...
        return this.data.reaction ?? '🎉'; // @XEfnexX To-Do
