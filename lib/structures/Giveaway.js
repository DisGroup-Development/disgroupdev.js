const { Client, ColorResolvable, Emoji, MessageMentionOptions, Snowflake } = require('discord.js');
 ...
 * @property {?String} title The title of the giveaway embed (default: "{this.prize}")
