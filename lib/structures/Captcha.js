...
class Captcha {
     ...
     * @param {CaptchaOptions} options The options of the captcha
     */
    constructor(options = {}) {
     ...
     * @param {Number} length The length of the text (default: 6)
     * @returns {String}
     * @public
     */
    static randomText(length = 6) {
        ...
        return Math.random().toString(36).replace(/[^a-z]|[gkqr]+/gi, '')
            .substring(0, length)
            .toUpperCase();
    }
     ...
     * @param {Array<Number>} arr The array to shuffle
