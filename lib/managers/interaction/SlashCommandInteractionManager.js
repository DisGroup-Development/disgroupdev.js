            ...
            try {
                ...
                if(slashCommand.guildOnly) {
                    ...
                    for(const guild of guilds) {
                        // @XEfnexX To-Do
                        const guildCommand = await guild.commands.create({ name: slashCommand.name, nameLocalizations: slashCommand.nameLocalizations, description: slashCommand.description, descriptionLocalizations: slashCommand.descriptionLocalizations, type: "CHAT_INPUT", options: slashCommand.options });
                    ...
                    // @XEfnexX To-Do
                    const applicationCommand = await this.client.application.commands.create({ name: slashCommand.name, nameLocalizations: slashCommand.nameLocalizations, description: slashCommand.description, descriptionLocalizations: slashCommand.descriptionLocalizations, type: "CHAT_INPUT", options: slashCommand.options });
