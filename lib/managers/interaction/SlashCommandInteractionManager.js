            ...
            try {
                ...
                if(slashCommand.guildOnly) {
                    ...
                    for(const guild of guilds) {
                        ...
                        const guildCommand = await guild.commands.create({ name: slashCommand.name, nameLocalizations: slashCommand.nameLocalizations, description: slashCommand.description, descriptionLocalizations: slashCommand.descriptionLocalizations, type: "CHAT_INPUT", options: slashCommand.options, defaultPermission: slashCommand.defaultEnabled });
