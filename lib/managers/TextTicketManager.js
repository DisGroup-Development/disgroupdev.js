const { CategoryChannel, Client, Collection, Guild, GuildMember, GuildResolvable, OverwriteData, Role, Snowflake, User, UserResolvable } = require('discord.js');
const { OverwriteType, PermissionFlagsBits } = require('discord-api-types/v10');
    ...
    async closeTicket(ticket) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            ticketPermissions.push({
                id: ticket.userId,
                deny: [PermissionFlagsBits.AttachFiles, PermissionFlagsBits.AddReactions, PermissionFlagsBits.EmbedLinks, PermissionFlagsBits.ReadMessageHistory, PermissionFlagsBits.SendMessages, PermissionFlagsBits.UseExternalEmojis, PermissionFlagsBits.UseExternalStickers, PermissionFlagsBits.ViewChannel],
            ...
            for(const staffRole of this.options.staffRoles) {
                ...
                ticketPermissions.push({
                    ...
                    allow: [PermissionFlagsBits.AttachFiles, PermissionFlagsBits.AddReactions, PermissionFlagsBits.EmbedLinks, PermissionFlagsBits.ReadMessageHistory, PermissionFlagsBits.SendMessages, PermissionFlagsBits.UseExternalEmojis, PermissionFlagsBits.UseExternalStickers, PermissionFlagsBits.ViewChannel],
                    type: OverwriteType.Role
                });
